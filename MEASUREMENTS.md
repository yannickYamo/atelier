...
| `core/fidelity/graded-readout.ts:4`, `core/inference/client.ts:82`, `core/distinctiveness/floor.ts:25` | three instruments produced zero abstentions across 150 observations | the 126 above plus a third instrument on 24 more; same caveat |
