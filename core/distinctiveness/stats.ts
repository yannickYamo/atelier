// atelier/core/distinctiveness/stats.ts — the ONE owner of the t distribution and two-sample
// comparison, ported so the floor's arithmetic travels with it.
//
...
/** Which column of T_TABLE a quantile reads. Only the three we actually use are representable. */
